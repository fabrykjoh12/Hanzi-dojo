...
- [x] HSK 3-6 vocabulary: 4,498 Chinese words to study, search, and test — the full HSK 3-6 word list, matched to the 2025 syllabus. Example sentences and audio for them are still being generated.
...
- [ ] **Stories for HSK 3-6** — the vocabulary has shipped; example sentences, audio, and graded stories for these levels are the missing pieces (pending a higher LLM quota).
