...
- [x] **The manga speech bubbles look like speech bubbles now.** They were drawn as true ellipses, which meant a one-line balloon stretched into a huge flat lens that covered half the picture and left its words marooned in the middle of it — worst of all with pinyin turned off, when the balloons are shortest. They're now properly balloon-shaped at any length. The thought bubble lost its dashed outline, which read as "this thing is selected" rather than "this is a thought", and your own chosen reply is marked with a soft tint instead of a bright red ring around it.
