...
**Just shipped**
- [x] **Sixty new covers, in ten different styles.** Every story that shipped today has its own illustration, and the seasons no longer all look alike: the cooking story is warm gouache, the cat-and-chair season is ink wash, the eighteen-chapter sea serial is a woodblock print that moves from cold blue to night to dawn as the story does, the dog is a two-colour riso print, the comedy is a manhua page, the empty-building mystery is film noir, the shop story is a mid-century screenprint, and the one about five people remembering the same cat five different ways is a torn-paper collage that deliberately does not line up.
