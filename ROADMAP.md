...
**Just shipped**
- [x] **A written playbook for every story we make.** Before a story or manhua episode reaches the shelf it now has to clear a written, public-inside-the-repo standard: what makes a hook work at every HSK level, why a beginner story is never allowed to be childish, a 100-point quality bar it must score against, and the next twenty stories planned across levels and genres — from an HSK 1 mystery about eleven teacups to a night-radio serial that grows from HSK 4 to HSK 6 exactly as you do. First up: the promised 第四话 of *The Rainy-Day Noodle Shop*.
