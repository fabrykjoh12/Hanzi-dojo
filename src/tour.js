...
export const TOURS = {
  home: [
    ...
    },
    {
      ...
      title: 'Then read',
      body: 'Reading is the other half of the method. Finishing today’s cards unlocks the next chapter of the story you’re on — it waits for you here.',
      placement: 'below',
    },
    {
      id: 'home-week',
      anchor: 'home-week',
      title: 'Your week',
      body: 'No streaks to protect — this just shows the days you studied and what’s coming. A quiet day costs you nothing.',
      placement: 'auto',
    },
    {
      id: 'home-nav',
