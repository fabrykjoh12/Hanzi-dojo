  ...
  home: [
    {
      ...
      body: 'Home walks you through one day at a time: cards first, then a story, then a little practice. This is the step you are on.',
      placement: 'below',
    },
    {
      id: 'home-then-read',
      ...
      title: 'Then read',
      body: 'Reading is the other half of the method. Finishing today’s cards unlocks the next chapter of the story you’re on — it waits here, and takes over the screen when it is ready.',
      placement: 'below',
    },
    {
      id: 'home-nav',
      ...
      body: 'Stories, Practice and your Profile live here. Cards first, then a story — that’s the whole daily loop.',
      placement: 'auto',
    },
  ],
