...
// A toast's icon comes from its `kind`, and Award is the default because the
// first toast in the app was an achievement seal. That default is why an
// untagged toast — an apology included — arrives wearing a medal, which §1's
// calm, observational rule rules out for bad news.
//
// NOTE FOR THE MERGE: claude/fab-26-narrow-client-grants adds these same two
// entries for the dictionary limit toasts. The two additions are identical and
// either side of the conflict is the right resolution.
