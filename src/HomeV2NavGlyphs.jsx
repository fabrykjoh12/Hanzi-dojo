...
//
// This family now supplies the production mobile navigation and the related
// Home identity objects. Mobile uses Stories · Home · Practice; the remaining
// glyphs stay available to Cards, Profile, and internal reference surfaces.
//
