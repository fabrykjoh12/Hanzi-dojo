...
export const LANGUAGES = {
  chinese: {
    ...
    nativeName: '中文',
    // The word on Home's flashcard illustration (P14-5F). Illustrative content,
    // not the learner's data — but it lives here rather than in the drawing so
    // shared code cannot print hanzi on a frozen track's Home.
    sampleWord: '你好',
    sampleReading: 'nǐ hǎo',
    flag: '🇨🇳',
    accentHex: '#B83A24',
