...
const JA = {
  ...
  では: { reading: 'dewa', gloss: 'Formal negative marker (…では ありません = "is not"), or "well then…".' },
  ございます: { reading: 'gozaimasu', gloss: 'Very polite ending — ありがとうございます, おめでとうございます.' },
  おめでとう: { reading: 'omedetou', gloss: '"Congratulations!" — たんじょうび おめでとう = happy birthday.' },
