---
name: probe-producer
description: RECONNAISSANCE PROBE ONLY. A Bash-less producer used to test whether a PreToolUse hook declared in subagent frontmatter genuinely fires and genuinely denies. Not a production role. Never merge this file.
...
hooks:
  PreToolUse:
    - matcher: Edit|Write|MultiEdit|NotebookEdit
      hooks:
        - type: command
          command: node "$CLAUDE_PROJECT_DIR/tools/probe-path-guard.mjs"
color: yellow
---
