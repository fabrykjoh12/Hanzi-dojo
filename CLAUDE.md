...
| [`docs/AUTOMATION-AUTHORITY.md`](docs/AUTOMATION-AUTHORITY.md) | What a workflow may mutate, and why stale branches can't reach `main` or Discord | Adding or changing any workflow that writes |
