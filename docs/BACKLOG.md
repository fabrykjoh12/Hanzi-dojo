...
- [ ] **Cover art for the newest hand-authored chapters** (12 at HSK 1, 18 in the sea strand across HSK 1-3, 6 at HSK 2 t1, 6 at HSK 4 t1). The 45 HSK 4-6 chapters got theirs on 2026-07-29; these seasons still ship with the designed fallback. Pipeline is unchanged: author `data/story-covers.json`, then Actions → `story-images-apply`.
