...
- [ ] **Cover art for the 57 new hand-authored chapters** (45 at HSK 4-6, 12 at HSK 1). Every other published story has an illustration; these eleven seasons ship with the designed fallback. Pipeline is unchanged: author `data/story-covers.json`, then Actions → `story-images-apply`.
