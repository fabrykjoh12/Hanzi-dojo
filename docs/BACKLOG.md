...
## Database
- [ ] 🔴 **HSK 3-6 vocabulary audio is unreachable in production — `20260921000000_repair_hsk3_6_audio_paths.sql` COMMITTED, NOT APPLIED.** Measured live 2026-09-21: **4,491 of the 4,498** active HSK 3-6 words carry an `audio_path` pointing at an object that does not exist. Only 7 resolve. HSK 1 and 2 are fine — 497 of 497 resolve.
